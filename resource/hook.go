...
type FindEventHandler interface {
	OnFind(ctx context.Context,r *http.Request,  lookup *Lookup, page, perPage int) error
}

// FindEventHandlerFunc converts a function into a FindEventHandler.
type FindEventHandlerFunc func(ctx context.Context, r *http.Request,  lookup *Lookup, page, perPage int) error

// OnFind implements FindEventHandler
func (e FindEventHandlerFunc) OnFind(ctx context.Context, r *http.Request, lookup *Lookup, page, perPage int) error {
	return e(ctx, r, lookup, page, perPage)
}
...
type FoundEventHandler interface {
	OnFound(ctx context.Context, r *http.Request, lookup *Lookup, list **ItemList, err *error)
}

// FoundEventHandlerFunc converts a function into a FoundEventHandler.
type FoundEventHandlerFunc func(ctx context.Context, r *http.Request,  lookup *Lookup, list **ItemList, err *error)

// OnFound implements FoundEventHandler
func (e FoundEventHandlerFunc) OnFound(ctx context.Context, r *http.Request, lookup *Lookup, list **ItemList, err *error) {
	e(ctx, r, lookup, list, err)
}
...
type GetEventHandler interface {
	OnGet(ctx context.Context, r *http.Request,  id interface{}) error
}

// GetEventHandlerFunc converts a function into a GetEventHandler.
type GetEventHandlerFunc func(ctx context.Context,r *http.Request,  id interface{}) error

// OnGet implements GetEventHandler
func (e GetEventHandlerFunc) OnGet(ctx context.Context, r *http.Request, id interface{}) error {
	return e(ctx, r, id)
}
...
type GotEventHandler interface {
	OnGot(ctx context.Context, r *http.Request, item **Item, err *error)
}

// GotEventHandlerFunc converts a function into a FoundEventHandler.
type GotEventHandlerFunc func(ctx context.Context, r *http.Request, item **Item, err *error)

// OnGot implements GotEventHandler
func (e GotEventHandlerFunc) OnGot(ctx context.Context, r *http.Request, item **Item, err *error) {
	e(ctx, r, item, err)
}
...
type InsertEventHandler interface {
	OnInsert(ctx context.Context, r *http.Request, items []*Item) error
}

// InsertEventHandlerFunc converts a function into a GetEventHandler.
type InsertEventHandlerFunc func(ctx context.Context, r *http.Request, items []*Item) error

// OnInsert implements InsertEventHandler
func (e InsertEventHandlerFunc) OnInsert(ctx context.Context, r *http.Request, items []*Item) error {
	return e(ctx,r, items)
}
...
type InsertedEventHandler interface {
	OnInserted(ctx context.Context, r *http.Request, items []*Item, err *error)
}

// InsertedEventHandlerFunc converts a function into a FoundEventHandler.
type InsertedEventHandlerFunc func(ctx context.Context, r *http.Request, items []*Item, err *error)

// OnInserted implements InsertedEventHandler
func (e InsertedEventHandlerFunc) OnInserted(ctx context.Context, r *http.Request, items []*Item, err *error) {
	e(ctx, r, items, err)
}
...
type UpdateEventHandler interface {
	OnUpdate(ctx context.Context, r *http.Request,  item *Item, original *Item) error
}

// UpdateEventHandlerFunc converts a function into a GetEventHandler.
type UpdateEventHandlerFunc func(ctx context.Context, r *http.Request,  item *Item, original *Item) error

// OnUpdate implements UpdateEventHandler
func (e UpdateEventHandlerFunc) OnUpdate(ctx context.Context, r *http.Request, item *Item, original *Item) error {
	return e(ctx, r, item, original)
}
...
type UpdatedEventHandler interface {
	OnUpdated(ctx context.Context, r *http.Request, item *Item, original *Item, err *error)
}

// UpdatedEventHandlerFunc converts a function into a FoundEventHandler.
type UpdatedEventHandlerFunc func(ctx context.Context, r *http.Request, item *Item, original *Item, err *error)

// OnUpdated implements UpdatedEventHandler
func (e UpdatedEventHandlerFunc) OnUpdated(ctx context.Context, r *http.Request,  item *Item, original *Item, err *error) {
	e(ctx, r, item, original, err)
}
...
type DeleteEventHandler interface {
	OnDelete(ctx context.Context,r *http.Request,  item *Item) error
}

// DeleteEventHandlerFunc converts a function into a GetEventHandler.
type DeleteEventHandlerFunc func(ctx context.Context, r *http.Request,  item *Item) error

// OnDelete implements DeleteEventHandler
func (e DeleteEventHandlerFunc) OnDelete(ctx context.Context,r *http.Request,  item *Item) error {
	return e(ctx, r, item)
}
...
type DeletedEventHandler interface {
	OnDeleted(ctx context.Context, r *http.Request, item *Item, err *error)
}

// DeletedEventHandlerFunc converts a function into a FoundEventHandler.
type DeletedEventHandlerFunc func(ctx context.Context, r *http.Request, item *Item, err *error)

// OnDeleted implements DeletedEventHandler
func (e DeletedEventHandlerFunc) OnDeleted(ctx context.Context, r *http.Request,  item *Item, err *error) {
	e(ctx, r, item, err)
}
...
type ClearEventHandler interface {
	OnClear(ctx context.Context, r *http.Request, lookup *Lookup) error
}

// ClearEventHandlerFunc converts a function into a GetEventHandler.
type ClearEventHandlerFunc func(ctx context.Context,r *http.Request,  lookup *Lookup) error

// OnClear implements ClearEventHandler
func (e ClearEventHandlerFunc) OnClear(ctx context.Context, r *http.Request, lookup *Lookup) error {
	return e(ctx, r, lookup)
}
...
type ClearedEventHandler interface {
	OnCleared(ctx context.Context, r *http.Request,  lookup *Lookup, deleted *int, err *error)
}

// ClearedEventHandlerFunc converts a function into a FoundEventHandler.
type ClearedEventHandlerFunc func(ctx context.Context, r *http.Request, lookup *Lookup, deleted *int, err *error)

// OnCleared implements ClearedEventHandler
func (e ClearedEventHandlerFunc) OnCleared(ctx context.Context, r *http.Request, lookup *Lookup, deleted *int, err *error) {
	e(ctx, r, lookup, deleted, err)
}
...
func (h *eventHandler) onFind(ctx context.Context, r *http.Request, lookup *Lookup, page, perPage int) error {
	for _, e := range h.onFindH {
		if err := e.OnFind(ctx, r, lookup, page, perPage); err != nil {
			return err
		}
	}
	return nil
...
func (h *eventHandler) onFound(ctx context.Context, r *http.Request,  lookup *Lookup, list **ItemList, err *error) {
	for _, e := range h.onFoundH {
		e.OnFound(ctx, r, lookup, list, err)
	}
}

func (h *eventHandler) onGet(ctx context.Context, r *http.Request, id interface{}) error {
	for _, e := range h.onGetH {
		if err := e.OnGet(ctx, r, id); err != nil {
			return err
		}
	}
	return nil
...
func (h *eventHandler) onGot(ctx context.Context, r *http.Request, item **Item, err *error) {
	for _, e := range h.onGotH {
		e.OnGot(ctx, r, item, err)
	}
}

func (h *eventHandler) onInsert(ctx context.Context, r *http.Request, items []*Item) error {
	for _, e := range h.onInsertH {
		if err := e.OnInsert(ctx, r, items); err != nil {
			return err
		}
	}
	return nil
...
func (h *eventHandler) onInserted(ctx context.Context, r *http.Request,  items []*Item, err *error) {
	for _, e := range h.onInsertedH {
		e.OnInserted(ctx, r, items, err)
	}
}

func (h *eventHandler) onUpdate(ctx context.Context, r *http.Request, item *Item, original *Item) error {
	for _, e := range h.onUpdateH {
		if err := e.OnUpdate(ctx, r, item, original); err != nil {
			return err
		}
	}
	return nil
...
func (h *eventHandler) onUpdated(ctx context.Context, r *http.Request, item *Item, original *Item, err *error) {
	for _, e := range h.onUpdatedH {
		e.OnUpdated(ctx, r, item, original, err)
	}
}

func (h *eventHandler) onDelete(ctx context.Context, r *http.Request, item *Item) error {
	for _, e := range h.onDeleteH {
		if err := e.OnDelete(ctx, r, item); err != nil {
			return err
		}
	}
	return nil
...
func (h *eventHandler) onDeleted(ctx context.Context, r *http.Request,  item *Item, err *error) {
	for _, e := range h.onDeletedH {
		e.OnDeleted(ctx, r, item, err)
	}
}

func (h *eventHandler) onClear(ctx context.Context, r *http.Request,  lookup *Lookup) error {
	for _, e := range h.onClearH {
		if err := e.OnClear(ctx, r, lookup); err != nil {
			return err
		}
	}
	return nil
...
func (h *eventHandler) onCleared(ctx context.Context, r *http.Request,  lookup *Lookup, deleted *int, err *error) {
	for _, e := range h.onClearedH {
		e.OnCleared(ctx, r, lookup, deleted, err)
	}
}
